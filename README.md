...
[![CI](https://github.com/tableverse-labs/tableverse/actions/workflows/release.yml/badge.svg)](https://github.com/tableverse-labs/tableverse/actions)
[![Docker](https://img.shields.io/badge/docker-ghcr.io-blue)](https://github.com/tableverse-labs/tableverse/pkgs/container/tableverse)
...
docker run --rm -v $(pwd):/data -p 8080:8080 \
  ghcr.io/tableverse-labs/tableverse:latest /data/file.parquet
```
