...
function CatalogIcon() {
  return (
    <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
      ...
      <rect x="1" y="9.5" width="6" height="1.5" rx="0.75" stroke="currentColor" strokeWidth="1.2" />
    </svg>
  );
}
      ...
      >
        <div style={{ padding: "16px", borderBottom: "1px solid var(--c-border)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <div style={{ display: "flex", gap: 6 }}>
            <button
              onClick={() => { setShowCatalogBrowser(true); toggleSourceManager(); }}
              style={{ padding: "5px 10px", fontSize: 12, background: "var(--c-bg)", color: "var(--c-text-2)", border: "1px solid var(--c-border)", borderRadius: 4, cursor: "pointer", display: "flex", alignItems: "center", gap: 5 }}
