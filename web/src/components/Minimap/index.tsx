...
import { DEFAULT_CELL_W, DEFAULT_CELL_H, SCROLLBAR_SIZE, headerHeightForZoom } from "../../lib/viewport";
...
export function Minimap() {
  ...
  if (!minimapVisible) {
    return (
      ...
      >
        <div style={{ height: headerH, flexShrink: 0, borderBottom: "1px solid var(--c-border)" }} />
  ...
  return (
    ...
    >
      <div style={{ height: headerH, flexShrink: 0, borderBottom: "1px solid var(--c-border)" }} />
      <div style={{ flex: 1, overflow: "hidden", position: "relative", marginBottom: SCROLLBAR_SIZE }}>
        {source ? (
          <>
            <MinimapCanvas
              panelW={minimapWidth}
